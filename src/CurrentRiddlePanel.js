...
function CurrentRiddlePanel(props) {
    ...
    if (props.isMobile) {
        ...
        if (riddle.creditsCost > 0) {
            paidRiddleMobileHeader = <div
                className="col-xs-12 paid-riddle-mobile-header red-border r18">NAGRODA PIENIĘŻNA {riddle.winPrize}ZŁ</div>
        }

        return (
            <div key={riddle.riddleId} className="visible-xs-block row whiteish-bg out-list-padding current-riddle" data-riddle-last-finished={riddle.lastFinished}>
                ...
                <div className="col-xs-12 col-sm-4 col-md-5 col-lg-3">
                    <div className="button-wrapper">
                        <button onClick={(e) => {
                            redirect();
                        }} className="btn-enigmata">Dołącz i graj
                        </button>
                    </div>
                </div>
            </div>
        ...
        return (
            <div key={riddle.riddleId}
                 className="hidden-xs row whiteish-bg out-list-padding current-riddle riddle-desktop-panel" data-riddle-last-finished={riddle.lastFinished}>
...
export default withRouter(connect(mapStateToProps)(CurrentRiddlePanel));